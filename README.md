<!--
  ⚡ ONE THING TO DO: find-and-replace every  YOUR_GITHUB_USERNAME  below with your real handle.
  (For the snake animation to appear, also add the workflow in snake.yml — see the note that came with this file.)
-->
...
🧠 &nbsp; Evaluating frontier AI, one hard task at a time  
📈 &nbsp; Roots in markets, consulting & quant  
🛠️ &nbsp; Always shipping something  
⌚ &nbsp; Watch modder when the terminal's closed  
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:2DD4BF,100:8B5CF6&height=120&section=footer" width="100%" />
